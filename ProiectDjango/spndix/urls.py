...
urlpatterns = [
    ...
    path('subscriptions/', views.lista_subscriptions, name='lista_subscriptions'),
    path('subscriptions/editeaza/<int:pk>/', views.editeaza_subscription, name='editeaza_subscription'),
    path('subscriptions/activeaza/<int:pk>/', views.activeaza_subscription, name='activeaza_subscription'),
    path('subscriptions/anuleaza/<int:pk>/', views.anuleaza_subscription, name='anuleaza_subscription'),
    path('subscriptions/sterge/<int:pk>/', views.sterge_subscription, name='sterge_subscription'),
